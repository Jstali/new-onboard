...
const ADPPayrollForm = ({ employeeId, isReadOnly = false }) => {
  ...
  const formSections = {
    ...
    "LWF Information": [
      ...
      "LWFRelationship",
      "LWFID",
      "ProfessionaltaxgroupDescription",
      "PFComputationalGroup",
    ],
    "Contact Information": ["Mobile Number", "PhoneNumber1", "PhoneNumber2"],
    "Address Information": [
      "Address1",
      "Address2",
      "Address3",
    ...
    "PF/ESI Information": [
      ...
      "Taxregime",
      "AlreadyMemberInPF",
      "AlreadyMemberInPension",
      "WithdrawnPFandPension",
    ...
    "Eligibility Information": [
      "OtEligibility",
      "AutoShiftEligibility",
      "MobileUser",
      "WebPunch",
      "AttendanceExceptionEligibility",
